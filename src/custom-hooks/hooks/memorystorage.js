...
const API = { clear: 1, getItem: 1, id: 1, key: 1, length: 1, removeItem: 1, setItem: 1 }
 ...
 */
export function MemoryStorage(id) {
  ...
  return typeof Proxy === 'undefined' ? result : new Proxy(result, { ownKeys() { return enumerableKeys() } })

  // helper functions
  function uncloakedKeys() { return Object.keys(result).filter((x) => { return !(x in API) }) }
